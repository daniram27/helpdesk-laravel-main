...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('tickets', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('priority_id')->nullable();('priority_id');
            $table->unsignedBigInteger('unit_id')->nullable();('unit_id');
            $table->unsignedBigInteger('owner_id')->index('owner_id');
            $table->unsignedBigInteger('problem_category_id')->nullable();('problem_category_id');
            $table->string('title');
